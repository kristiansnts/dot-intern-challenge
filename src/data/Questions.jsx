                ...
                <div className="question">
                            ...
                            <ul>
                            {
                                answersArray[step].answers.map((item, index) => (
                                    <li key={index + 1}>
                                        ...
                                        }} className={`cursor-pointer w-full rounded-lg px-4 py-2 my-2 ${activeButtonIndex == index + 1 ? 'bg-black text-slate-200 outline-none ring ring-white': 'bg-slate-200 '} hover:bg-green-600 hover:border-2 hover:border-white hover:text-slate-200`}>{decode(item, {level: 'html5'})}</button>
                                    </li>
                                ))
                            }
                            </ul>
                        ...
                        <div className="action flex">
                            <div className="text-white">
                                <span className="mr-5">Questions: <span className="font-bold text-white">{state.questions.length}</span></span>
                                <span>No: {step + 1}</span>
                            </div>
                            <button
                                onClick={handleNext}
                                className="bg-white rounded-lg px-4 py-2 font-bold text-green-600 block ml-auto hover:bg-green-600 hover:text-white hover:border-2 hover:border-white "
                            >
